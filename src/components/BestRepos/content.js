export const reposContent = {
  ...
  nlwTogether: {
    ...
    description:
      "Desenvolvi este app na NLW edição Together. Esse app é um ambiente para Q&A onde usuários conectam com suas contas Google, fazem perguntas e tem suas repostas. Esses dados são armazenados no Firebase e retroalimenta o app.",
