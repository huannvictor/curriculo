...
export const xpContent = {
  ...
  FreelanceFullStackJr: {
    ...
    company: "",
    period: "dezembro 2022 - atualmente",
    description:
  ...
  WebDeveloperJunior: {
    ...
    period: "dezembro 2022 - fevereiro 2023",
    description:
  ...
  FreelancerGraphicDesigner: {
    ...
    description:
      "Criar mídias digitais para postagens em redes sociais. Design de logos, identidade visual para pessoas físicas, empresas de pequeno porte e outras organizações.",
    softSkills:
      "Lidar com prazos, relacionamento com cliente, absorver as ideias apresentadas e conseguir expressar em algum tipo de design.",
  },
};
